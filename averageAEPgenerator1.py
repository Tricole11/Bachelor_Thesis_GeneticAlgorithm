...
def sector_AEP(f, A, k, wd, ti, centers, my_wt, turbineDiameter, turbineTipClearence, Collumns, rows):
    ...
    for i in range(len(A)):
        print("In the AEP generator we are in iteration: ", str(i+1))
        ...
        coordinates = generateMultiRotorCoordinates.generateMultiRotorCoordinates(centers, i, turbineDiameter, turbineTipClearence, Collumns, rows)
